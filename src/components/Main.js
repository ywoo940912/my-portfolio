...
export default function Main() {
    return(    
        ...
        <div className=" w-full h-[20px] grid object-right px-550 bg-[cream]">
            <div>
                <img className="object-right ml-[65vw] mt-[20vh] " src={Profile} alt='Profile image' style={{ width: '300px'}} />
            </div>
        </div>

            {/* Container */}
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            <p className='text-[#34626C]  drop-shadow-xl'>Hi, my name is</p>
            ...
            <p className='text-[#263159] py-4 max-w-[700px] drop-shadow-xl'>
